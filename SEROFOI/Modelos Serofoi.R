...
dat_PRI_HPVr<- data.frame (filter( dat, survey == "PRI-001-02"))
...
PRI_HPVHr<- cowplot::plot_grid(HPV_constant_plot_PRI_HPVHr, HPV_time_plot_PRI_HPVHr,HPV_age_plot_PRI_HPVHr, ncol = 3)
